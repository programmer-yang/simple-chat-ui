...
var Header = function (props) {
    var children = props.children, containerRef = props.containerRef, chatData = props.chatData, disable = props.disable;
    var contianerStyle = {};
    ...
    contianerStyle.height = "calc(100vh - " + (disable ? 0 : 54) + "px - " + containerHeightDiff + "px)";
